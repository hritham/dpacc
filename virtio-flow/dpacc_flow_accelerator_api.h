...
* \brief Flow Accelerator Device information TBD add more fields 
*/
struct g_flow_device_info {

        /**< flow accclerator name*/
	char flow_accel_name[G_FLOW_ACCEL_APP_NAME_SIZE+1]; 
};
...
/** ingroup FLOW_ACCELERATOR
* \struct g_flow_open_flow_accel_inargs
* \brief Open Flow Accelerator devices info passing to g_flow_device_open() as Inargs \n\n
*/
struct g_flow_open_flow_accel_inargs {
...
* \brief Details of port that attached to Flow Accelerator \n\n
*/
struct g_flow_port_info {
...
struct g_flow_get_stage_object_inargs {
     ...
     /** Id of the object to get details, G_FLOW_OBJECT_ALL get all objects */
     uint32_t id; 
...
int32_t g_flow_device_open(
	struct g_flow_open_flow_accel_inargs *in,
...
/*! 
 * \brief Add packet processing stage to previously opened Flow Accelerator instance 
 *
 * \param[in] handle- Flow Accelerator handle 
 * 
